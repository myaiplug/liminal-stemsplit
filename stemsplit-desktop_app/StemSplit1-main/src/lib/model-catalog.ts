...
> = {
  demucs: {
    label: 'Demucs',
    subtitle: 'Hybrid transformer — full-band multistem',
    color: '#22d3ee',
    glow: 'rgba(34,211,238,0.35)',
  },
  mdx: {
    label: 'MDX-Net',
    subtitle: 'Spectral masking — vocal & specialty ONNX',
    color: '#a78bfa',
    glow: 'rgba(167,139,250,0.35)',
  },
  roformer: {
    label: 'Roformer',
    subtitle: 'Band-split transformer — ultra vocal fidelity',
    color: '#f472b6',
    glow: 'rgba(244,114,182,0.35)',
  },
  vr: {
    label: 'VR Architecture',
    subtitle: 'Cascaded UVR nets — karaoke, MGM, restoration',
    color: '#fb923c',
    glow: 'rgba(251,146,60,0.35)',
  },
  spleeter: {
    label: 'Spleeter',
    subtitle: 'Lightweight baseline — free tier',
    color: '#94a3b8',
    glow: 'rgba(148,163,184,0.25)',
  },
  drumsep: {
    label: 'Drumsep',
    subtitle: 'Percussion micro-stems',
    color: '#fbbf24',
    glow: 'rgba(251,191,36,0.35)',
  },
  ensemble: {
    label: 'Ensemble',
    subtitle: 'Multi-model fusion presets',
    color: '#e879f9',
    glow: 'rgba(232,121,249,0.4)',
  },
  karaoke: {
    label: 'Karaoke',
    subtitle: 'Lead vs backing vocal split',
    color: '#fda4af',
    glow: 'rgba(253,164,175,0.4)',
  },
  postfx: {
    label: 'Post-FX',
    subtitle: 'Apollo · Matchering · Transkun',
    color: '#34d399',
    glow: 'rgba(52,211,153,0.35)',
  },
  instrument: {
    label: 'Instruments',
    subtitle: 'Guitar, piano, strings, brass, choir…',
    color: '#a3e635',
