...
import { APP_DISPLAY_NAME } from '@/lib/app-version';
...
const TitleBar: React.FC<TitleBarProps> = ({ onToolTrigger }) => {
    ...
    useEffect(() => {
        import('@/lib/tauri-runtime').then(({ isTauriRuntime }) => {
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <span className="text-[9px] text-cyan-400/70 font-minimal font-light tracking-tight pointer-events-none whitespace-nowrap">{APP_DISPLAY_NAME}</span>
                </div>
